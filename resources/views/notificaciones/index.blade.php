                    ...
                    <div class="divide-y divide-gray-200">
                        ...
                        <div class="p-5 lg:flex lg:justify-between lg:items-center">
                            ...
                            <div class="mt-5 lg:mt-0">
                                <a class="bg-indigo-500 p-3 text-sm uppercase font-bold text-white rounded-lg" href="{{ route('candidatos.index', $notificacion->data['id_vacante']) }}" title="">Ver Candidatos</a>
                            </div>
                        </div>
                        @empty
